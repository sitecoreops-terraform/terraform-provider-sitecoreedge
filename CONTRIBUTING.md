...
* `pkg/apiclient/` which is a client to interact with the [Sitecore Experience Edge Admin API](https://doc.sitecore.com/sai/en/developers/sitecoreai/admin-api.html)
